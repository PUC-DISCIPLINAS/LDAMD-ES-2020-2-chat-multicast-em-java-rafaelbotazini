...
public class UDPServer {
    ...
    private ReceivetHandler requestHandler;
    ...
    public void listen(int port) throws SocketException, IOException {
        ...
        while (true) {
            ...
            String replyMessage = requestHandler != null ? requestHandler.reply(data) : "";
    ...
    public void setRequestHandler(ReceivetHandler requestHandler) {
